                ...
                <div class="card">
                  <form method="post" action="controllers/machine-controller.php" class="needs-validation" novalidate="">
                    <div class="card-header">
                      <h4>New House Building Project Machine or Equipment</h4>
                    </div>
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="daily_rate" class="form-control" required="">
                        <div class="invalid-feedback">
                          What's the rate per day for this equipment?
                        </div>
                      </div>
                    </div>
